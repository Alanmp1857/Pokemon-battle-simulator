    ...
    <div className="h-[95%] w-full flex">
      <div className="h-[95%] w-full mt-12 m-8 bg-[#212121] border-2 border-black flex flex-col items-center">
          ...
          {messageList.map((mes, index) => {
            return (
              <div key={index} className="text-white m-2">
                <span
                  className={`text-${mes.username ? "green" : "blue"}-400 mr-2`}
                >
                  {mes.username ? mes.username : username}:
                </span>
        ...
        <div className="h-auto w-full">
          <form
            className="h-42 w-full flex items-center self-place-end"
          ...
          >
            <input
              ...
              className="border-black border-2 m-2 w-[80%]"
            ></input>
            <Button
